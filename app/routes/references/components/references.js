    ...
    return {
        ...
        execute: function() {
            ReferencesComponent = (function () {
                ...
                function ReferencesComponent(window, session, referenceService, lpcReportService) {
                    this.window = window;
                ...
                ReferencesComponent.prototype.getLPCReports = function (page, limit, borough, objectType) {
                    var _this = this;
                    this.lpcReportService.getLPCReports(page, limit, borough, objectType).subscribe(function (data) { _this.properties = _this.filteredReference = data; }, function () { return console.log('done loading getLPCReports'); });
                ...
                ReferencesComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [Window, session_1.SessionService, references_1.ReferencesService, lpcreport_1.LPCReportService])
                ], ReferencesComponent);
