System.register(['@angular/core', '../sidebar/userblock/userblock.service', '../../core/settings/settings.service', 'screenfull', 'jquery.browser'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, userblock_service_1, settings_service_1, screenfull, browser;
    var HeaderComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            HeaderComponent = (function () {
                function HeaderComponent(userblockService, settings) {
                ...
                HeaderComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [userblock_service_1.UserblockService, settings_service_1.SettingsService])
                ], HeaderComponent);
