System.register(['@angular/core', './layout.component', './sidebar/sidebar.component', './header/header.component', './header/navsearch/navsearch.component', './sidebar/userblock/userblock.component', './sidebar/userblock/userblock.service', './footer/footer.component', '../shared/shared.module'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, layout_component_1, sidebar_component_1, header_component_1, navsearch_component_1, userblock_component_1, userblock_service_1, footer_component_1, shared_module_1;
    var LayoutModule;
    return {
        setters:[
            function (core_1_1) {
