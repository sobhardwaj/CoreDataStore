System.register(['@angular/core', '@angular/common', '@angular/forms', '@angular/router', '@angular/http', 'ng2-bootstrap/ng2-bootstrap', 'ng2-select/ng2-select', 'angular2-toaster/angular2-toaster', './colors/colors.service', './services/session', './directives/checkall/checkall.directive', './directives/now/now.directive', './directives/scrollable/scrollable.directive', './pipes/capitalize', './pipes/trim'], function(exports_1, context_1) {
    ...
    var core_1, common_1, forms_1, router_1, http_1, ng2_bootstrap_1, ng2_select_1, angular2_toaster_1, colors_service_1, session_1, checkall_directive_1, now_directive_1, scrollable_directive_1, capitalize_1, trim_1;
    var SharedModule;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (checkall_directive_1_1) {
                checkall_directive_1 = checkall_directive_1_1;
            },
            function (now_directive_1_1) {
                now_directive_1 = now_directive_1_1;
            },
            function (scrollable_directive_1_1) {
                scrollable_directive_1 = scrollable_directive_1_1;
            },
