...
describe('MutationObserver', test_util_1.ifEnvSupports('MutationObserver', function () {
    var elt;
...
describe('WebKitMutationObserver', test_util_1.ifEnvSupports('WebKitMutationObserver', function () {
    var testZone = Zone.current.fork({ name: 'test' });
    it('should run observers within the zone', function (done) {
        var elt;
        testZone.run(function () {
...
//# sourceMappingURL=MutationObserver.spec.js.map