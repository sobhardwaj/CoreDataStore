...
var FilterSelectboxComponent = /** @class */ (function () {
    ...
    FilterSelectboxComponent.prototype.ngOnChanges = function (change) {
        if (change['active']) {
            this.selected = [];
    ...
    ], FilterSelectboxComponent.prototype, "disabled", void 0);
    __decorate([
        core_1.Output(),
...
//# sourceMappingURL=filterSelectbox.js.map