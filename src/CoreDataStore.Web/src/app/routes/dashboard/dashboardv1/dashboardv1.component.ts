...
@Component({
  ...
  templateUrl: 'app/routes/dashboard/dashboardv1/dashboardv1.component.html'
})
export class Dashboardv1Component implements OnInit {
  ...
  constructor(private colors: ColorsService, private http: Http) {
    http.get('server/chart/spline.json').map(data => data.json()).subscribe(data => this.splineData = data);
  }
