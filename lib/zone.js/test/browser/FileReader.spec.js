...
describe('FileReader', test_util_1.ifEnvSupports('FileReader', function () {
    var fileReader;
    var blob;
    ...
    describe('EventTarget methods', test_util_1.ifEnvSupports(supportsEventTargetFns, function () {
